...
function buildGui()
    ...
    local BG = Color3.fromRGB(12,6,18)
    local BG2 = Color3.fromRGB(20,9,30)
    local ROW_BG = Color3.fromRGB(16,7,24)
    local ROW_BORDER = Color3.fromRGB(68,28,92)
    local GRAY = Color3.fromRGB(82,42,100)
    local INP = Color3.fromRGB(18,8,27)
    local OFF = Color3.fromRGB(30,12,42)
    local TAB_ACTIVE = Color3.fromRGB(190,105,255)
    local TAB_INACT = Color3.fromRGB(115,60,145)
    local SECT_LBL = Color3.fromRGB(210,150,255)
    local HOV = Color3.fromRGB(34,13,48)
    local ON_COLOR = Color3.fromRGB(190,105,255)
    local STROKE_COLOR = Color3.fromRGB(78,30,105)
    ...
    grad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(225,180,255)),
        ColorSequenceKeypoint.new(0.45, Color3.fromRGB(190,105,255)),
        ColorSequenceKeypoint.new(0.55, Color3.fromRGB(145,70,205)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(95,35,135))
    })
    grad.Rotation = 0
    ...
    closeBtn.BackgroundColor3 = Color3.fromRGB(24,9,34)
    ...
    closeBtn.MouseLeave:Connect(function()
        TS:Create(closeBtn, TweenInfo.new(0.12), {TextColor3 = WHITE, BackgroundColor3 = Color3.fromRGB(24,9,34)}):Play()
    end)
...
function createMobilePanel()
    ...
    local WHITE = Color3.fromRGB(255,255,255)
    local INACTIVE_BG = Color3.fromRGB(16,7,24)
    local INACTIVE_TEXT = Color3.fromRGB(225,205,240)
    local STROKE_COLOR = Color3.fromRGB(78,30,105)
    local ACTIVE_BG = Color3.fromRGB(190,105,255)
